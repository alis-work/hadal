...
- Go is the primary backend language. Start as a modular monolith; add separate workers only for asynchronous or independently scalable work. The initial Python queue worker invokes OpenAI transcription and translation APIs; future ML-specific workloads remain separate.
